...
@Component
class TeuteuSingingJob(scheduler: TaskScheduler, client: GatewayDiscordClient, private val songRepository: StaticSongRepository) :
    BaseCreateMessageJob(scheduler, client), RandomFutureInstant {

    override fun buildNextMessage(): ScheduledMessage =
        ScheduledMessage(Channels.TeuteuGeneral, randomInstant(), songRepository.any().content)
